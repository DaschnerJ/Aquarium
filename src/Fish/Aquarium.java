...
{ 
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2485563395186191433L;
	Image aquariumImage;
	Image memoryImage;
	...
	Aquarium()
	{
		setTitle("Justin's Aquarium");
		
		tracker = new MediaTracker(this);
		
		
		fishImages[0] = new ImageIcon(this.getClass().getResource("/Fish/fish1.gif")).getImage();
		tracker.addImage(fishImages[0], 0);
		
		fishImages[1] = new ImageIcon(this.getClass().getResource("/Fish/fish2.gif")).getImage();
		tracker.addImage(fishImages[1], 0);
		
		aquariumImage = new ImageIcon(this.getClass().getResource("/Fish/bubbles.gif")).getImage();
